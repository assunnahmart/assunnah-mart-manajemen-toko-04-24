...
-- Supaya pencatatan pembayaran piutang ke kas_umum_transactions SELALU punya 'transaction_number'

ALTER TABLE public.kas_umum_transactions
ALTER COLUMN transaction_number DROP DEFAULT;

-- Update function pembayaran terintegrasi
...
-- Pastikan generate_kas_transaction_number ada dan berjalan baik!

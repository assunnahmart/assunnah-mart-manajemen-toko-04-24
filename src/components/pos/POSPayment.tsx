...
const POSPayment = ({ cartItems, totalAmount, onClose, onSuccess }: POSPaymentProps) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const { data: transactionNumber } = await createTransaksi.mutateAsync({
        transaksi: {
          nomor_transaksi: '', // Will be generated by function
          jenis_pembayaran: paymentMethod === 'cash' ? 'tunai' : paymentMethod === 'card' ? 'kartu' : 'digital',
          subtotal: totalAmount,
          total: totalAmount,
          bayar: paid,
          kembalian: calculateChange(),
          status: 'selesai',
          catatan: printReceipt ? 'Cetak struk' : 'Tanpa struk'
        },
      ...
      await createPOSTransaction.mutateAsync({
        transaction: {
          ...
          notes: printReceipt ? 'Cetak struk' : 'Tanpa struk'
        },

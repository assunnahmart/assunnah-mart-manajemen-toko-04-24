...
import { ShoppingCart, Package, Users, CreditCard, BarChart3, TrendingUp, AlertTriangle, DollarSign, ShoppingBag, ClipboardList, Wallet } from 'lucide-react';
          ...
          <div className="container mx-auto p-6">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                ...
                {user?.role === 'kasir' ? ' Anda dapat mengakses sistem POS, konsinyasi harian, dan kas kasir.' : ' Kelola toko Anda dengan mudah.'}
              </p>
            </div>
            ...
            {user?.role !== 'kasir' && stockAlerts && stockAlerts.length > 0 && <Card className="mt-6">
                ...
                <CardContent>
                  ...
                  {stockAlerts.length > 5 && <Button variant="outline" className="w-full mt-4" onClick={() => navigate('/stock')}>
                ...
                <CardContent className="pt-4">
                  <div className="text-center">
                    ...
                    <div className="flex justify-center gap-3">
                      ...
                      <Button onClick={() => navigate('/konsinyasi-harian')} variant="outline" className="border-blue-600 text-blue-600 hover:bg-blue-50">
                        <Package className="h-4 w-4 mr-2" />
                        Konsinyasi
                      </Button>
                      <Button onClick={() => navigate('/kasir-kas')} variant="outline" className="border-blue-600 text-blue-600 hover:bg-blue-50">

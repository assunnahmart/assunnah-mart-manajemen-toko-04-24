...
-- 20250614000000_customer_receivables_summary.sql
-- Fungsi summary piutang pelanggan
...
-- 20250614000001_record_customer_payment_integrated.sql
-- Pencatatan pembayaran piutang terintegrasi
...
-- 20250614000002_sync_pos_credit_to_receivables.sql
-- Fungsi dan trigger sync POS ke customer receivables ledger
...
-- Bersihkan file migrasi lama (20250614000000_integrate_receivables_system.sql) jika sudah berhasil apply migration di atas!

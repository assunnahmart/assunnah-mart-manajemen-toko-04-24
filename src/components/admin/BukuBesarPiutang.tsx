...
import { Search, Users, CreditCard, Plus, Filter } from 'lucide-react';
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  id="customer"
                  value={paymentData.pelanggan_name}
                  onChange={(e) => setPaymentData(prev => ({ ...prev, pelanggan_name: e.target.value }))}
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handlePayment} className="flex-1" disabled={!paymentData.pelanggan_name || !paymentData.amount}>
                  Simpan
                </Button>
              </div>
            </div>
